<x-admin title="Tambah Induk Perusahaan">
    {{-- Custom CSS --}}
    @prepend('styles')
        <style>
            #pageTitle:hover {
    ...
    <h4 class="mb-4 fw-semibold d-inline-flex" id="pageTitle">
        <i class="bi bi-arrow-left-short" style="-webkit-text-stroke: 1px;"></i>&nbsp;&nbsp;Tambah Induk Perusahaan
    </h4>
    ...
    <div class="card border-0" style="box-shadow: rgba(13, 38, 76, 0.19) 0px 9px 20px">
        <div class="card-body p-lg-4">
            ...
            <form action="{{ route('parent_company.store') }}" method="POST">
                @csrf
    ...
    @prepend('scripts')
        <script>
            document.getElementById('pageTitle').addEventListener('click', function() {
                window.location.href = "{{ route('parent_company.index') }}";
            });
        </script>
    @endprepend
</x-admin>
