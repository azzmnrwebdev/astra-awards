<x-admin title="Kota/Kabupaten">
    {{-- Main Content --}}
    <h4 class="mb-4 fw-semibold d-inline-flex">Manajemen Kota/Kabupaten</h4>
                ...
                <table class="table table-hover text-nowrap align-middle mb-0">
                    ...
                    <tbody class="border-start border-end">
                        @forelse ($cities as $item)
                            <tr>
                                <td class="text-center py-3">{{ $loop->index + $cities->firstItem() }}</td>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.delete').click(function() {
                    ...
                    const deleteUrl = "{{ route('city.destroy', ['city' => ':id']) }}".replace(':id',
                        id);
