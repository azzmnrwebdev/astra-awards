<x-admin title="Edit {{ $jury->name }}">
    ...
    <h4 class="mb-4 fw-semibold d-inline-flex" id="pageTitle">
        <i class="bi bi-arrow-left-short" style="-webkit-text-stroke: 1px;"></i>&nbsp;&nbsp;Edit {{ $jury->name }}
    </h4>
    ...
    <div class="card border-0" style="box-shadow: rgba(13, 38, 76, 0.19) 0px 9px 20px">
        <div class="card-body p-lg-4">
            ...
            <form action="{{ route('jury.update', ['jury' => $jury->id]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9 col-xl-10">
                        <input type="text" name="name" id="name"
                            ...
                            value="{{ old('name', $jury->name) }}" placeholder="Nama Lengkap">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9 col-xl-10">
                        <input type="email" name="email" id="email"
                            ...
                            value="{{ old('email', $jury->email) }}" placeholder="example@gmail.com">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9 col-xl-10">
                        <input type="phone_number" name="phone_number" id="phone_number"
                            ...
                            value="{{ old('phone_number', $jury->phone_number) }}" placeholder="081234567890">
    ...
    @prepend('scripts')
        <script>
            document.getElementById('pageTitle').addEventListener('click', function() {
                window.location.href = "{{ route('jury.index') }}";
            });
        </script>
    @endprepend
</x-admin>
