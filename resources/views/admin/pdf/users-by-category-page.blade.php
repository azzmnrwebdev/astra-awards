...
<head>
    ...
    <title>Daftar Peserta Kategori {{ $categoryArea->name }} dan {{ $categoryMosque->name }}</title>
...
<body>
        ...
        <tbody>
            <tr>
                ...
                <td style="width: 30%; vertical-align: top; text-transform: uppercase; padding: 0; font-size: 12px;">
                    Laporan Peserta Yang Sudah Terdaftar Di Sistem Berdasarkan Kategori {{ $categoryArea->name }} Dan
                    {{ $categoryMosque->name }}
                </td>
            </tr>
            <tr>
    ...
    <h3 style="font-weight: 800; text-align: center; line-height: 20px;">
        ...
        Kategori {{ $categoryArea->name }} Dan {{ $categoryMosque->name }}
    </h3>
    ...
    <table id="table">
        <thead>
            <tr>
                ...
                <th style="text-align: center;">Kategori Area</th>
                <th style="text-align: center;">Kategori Masjid</th>
            </tr>
        </thead>
